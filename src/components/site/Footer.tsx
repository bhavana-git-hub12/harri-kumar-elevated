...
import { HOSTING_BABA_URL, navLinks, socials } from "@/lib/site-data";
    ...
    <footer className="relative border-t border-border pt-14 pb-10">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.2fr_0.8fr_0.8fr] lg:px-8">
        <div className="min-w-0">
          ...
          <p className="text-sm tracking-[0.2em] text-muted-foreground uppercase">CEO</p>
          <a
              ...
              return (
                <li key={social.label}>
                  <a
                    ...
                    className="magnetic glass-panel grid h-11 w-11 place-items-center rounded-xl text-foreground/85 hover:text-primary"
                  >
      ...
      <div className="mx-auto mt-12 max-w-7xl border-t border-border px-4 pt-6 text-xs text-muted-foreground sm:px-6 lg:px-8">
        © {new Date().getFullYear()} Harri Kumar · Hosting Baba. All rights reserved.
      </div>
    </footer>
  );
}